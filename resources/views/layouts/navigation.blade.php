        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" style="border: 1px solid #F00">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" style="border: 1px solid #F00">
                    <x-nav-link :href="route('view-search')" :active="request()->routeIs('view-search')">
                        Cerca Libro
                    </x-nav-link>
                </div>
            ...
            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ms-6" style="border: 1px solid #F00">
